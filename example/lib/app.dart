...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: IconSwitcherPage(config: config),
    );
  }
}
...
class IconSwitcherPage extends StatefulWidget {
  ...
  const IconSwitcherPage({super.key, required this.config});
...
class _IconSwitcherPageState extends State<IconSwitcherPage> {
  ...
  Future<void> _loadIconInfo() async {
    try {
      ...
      debugPrint('  Flavor: ${widget.config.flavor}');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('${widget.config.appName} - Icon Switcher'),
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          child: Text(
                            widget.config.flavor.toUpperCase(),
